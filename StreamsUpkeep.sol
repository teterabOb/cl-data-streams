...
contract StreamsUpkeep is ILogAutomation, StreamsLookupCompatibleInterface {
    ...
    TokenInterface public tokenFee;
    ...
    constructor() {
        verifier = IVerifierProxy(0xea9B98Be000FBEA7f6e88D08ebe70EbaAD10224c); //0xea9B98Be000FBEA7f6e88D08ebe70EbaAD10224c
        FEE_ADDRESS = 0xe39Ab88f8A4777030A534146A9Ca3B52bd5D43A3; // 0xe39Ab88f8A4777030A534146A9Ca3B52bd5D43A3 (WETH)
        tokenFee = TokenInterface(0xe39Ab88f8A4777030A534146A9Ca3B52bd5D43A3);
        owner = msg.sender;
    }
    ...
    function withdrawERC20() public onlyOwner(msg.sender){
        tokenFee.transfer(owner, tokenFee.balanceOf(address(this)));
    }

    receive() external payable {}

    modifier onlyOwner(address _caller){
        require(owner == _caller, "Only owner");
        _;
    }
}
